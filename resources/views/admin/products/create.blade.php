    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bahan') ? 'is-invalid' : '' }}" type="text" name="bahan" id="bahan" value="{{ old('bahan', '') }}">
                @if($errors->has('bahan'))
                    <div class="invalid-feedback">
                        {{ $errors->first('bahan') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fungsi') ? 'is-invalid' : '' }}" type="text" name="fungsi" id="fungsi" value="{{ old('fungsi', '') }}">
