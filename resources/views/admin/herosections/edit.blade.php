...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.herosections.update", [$herosection->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="hero_description">{{ trans('cruds.herosection.fields.hero_description') }}</label>
                <input class="form-control {{ $errors->has('hero_description') ? 'is-invalid' : '' }}" type="text" name="hero_description" id="hero_description" value="{{ old('hero_description', $herosection->hero_description) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $herosection->description) }}</textarea>
